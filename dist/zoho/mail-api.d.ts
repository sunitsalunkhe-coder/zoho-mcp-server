...
export declare function replyToMessage(messageId: string, bodyHtml: string, replyAll: boolean, folderId?: string, attachments?: import("./types.js").ZohoAttachmentInput[]): Promise<string>;
